...
assert_eq "✨ ░░░░░░░░░░  ·  demo/main*↑2  ·  ⏱️ 5m  ·  +12/-3" "${lines[0]}" "statusline integration renders the first line deterministically"
assert_eq "      1K/168K  ·  Claude Sonnet 4  ·  💧 1 tablespoons" "${lines[1]}" "statusline integration renders the second line deterministically"
