...
assert_eq "✨ ░░░░░░░░░░  ·  demo/main*↑2" "${lines[0]}" "statusline integration renders the first line deterministically"
assert_eq "      1K/168K  ·  💧 1 tablespoons  ·  Claude Sonnet 4  ·  +12/-3  ·  ⏱️ 5m" "${lines[1]}" "statusline integration renders the second line deterministically"
