...
assert_contains 'format_fun_power "$USE_TOKENS" "$((POWER_ITEM_INDEX - 1))"' "session fun-power formatter call should quote both args"
...
assert_not_contains 'format_fun_power $USE_TOKENS 6' "coal formatter should not use unquoted args"
assert_not_contains 'format_fun_power $USE_TOKENS 7' "reactor formatter should not use unquoted args"
...
assert_not_contains 'format_fun_power $USE_TOKENS $((POWER_ITEM_INDEX - 1))' "session fun-power formatter should not use unquoted args"
