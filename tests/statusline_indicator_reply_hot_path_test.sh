...
if grep -n '\$\((round_decimal_to_int_or_default|get_smart_pace_indicator|format_burst_indicator|get_trend_arrow)\b' \
    ...
    grep -n '\$\((round_decimal_to_int_or_default|get_smart_pace_indicator|format_burst_indicator|get_trend_arrow)\b' \
