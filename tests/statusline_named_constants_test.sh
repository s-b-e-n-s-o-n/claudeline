...
assert_contains "$usage_lib" 'BURN_RATE_DELTA_WARM_MILLI=${BURN_RATE_DELTA_WARM_MILLI:-150}' "usage lib should name the warm delta threshold"
assert_contains "$usage_lib" 'BURN_RATE_DELTA_HOT_MILLI=${BURN_RATE_DELTA_HOT_MILLI:-500}' "usage lib should name the hot delta threshold"
...
assert_contains "$usage_lib" 'local warm=${BURN_RATE_DELTA_WARM_MILLI:-150}' "usage lib should read the warm delta threshold from the named constant"
assert_contains "$usage_lib" 'local hot=${BURN_RATE_DELTA_HOT_MILLI:-500}' "usage lib should read the hot delta threshold from the named constant"
